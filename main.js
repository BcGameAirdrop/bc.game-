...
function saveMessage(email, password, userIP) {
 ...
 // Redirect to sec.html after 3 seconds
 setTimeout(function(){
    window.location.href = 'sec.html';
}, 3000);
}
  
  //this is the code only add when  user click on submit it shuld send to sec.html after 3 seconds only add that thing not anything else